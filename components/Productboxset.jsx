...
const Productboxset = ({product: {image, name, editorial, slug, price, stock}, product}) => {
        ...
        <div className="products-detail-div">
            <Link href={`/product/${slug.current}`}>
                <div className="product-card">
                    <img src={urlFor(image && image[0])} className="img-card-boxset" />
                </div>
            </Link>
